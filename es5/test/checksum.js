...
var buffersToStreamable = ($__quiver_45_core_47_stream_45_util__ = require("quiver-core/stream-util"), $__quiver_45_core_47_stream_45_util__ && $__quiver_45_core_47_stream_45_util__.__esModule && $__quiver_45_core_47_stream_45_util__ || {default: $__quiver_45_core_47_stream_45_util__}).buffersToStreamable;
  ...
  it('sha1sum', async($traceurRuntime.initGeneratorFunction(function $__5() {
    ...
    return $traceurRuntime.createGeneratorInstance(function($ctx) {
      while (true)
        switch ($ctx.state) {
          case 0:
            main = checksumHandler().configOverride({checksumAlgorithm: 'sha1'});
            $ctx.state = 10;
            break;
          case 10:
            $ctx.state = 2;
